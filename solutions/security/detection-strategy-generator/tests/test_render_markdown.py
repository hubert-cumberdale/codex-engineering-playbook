...
def test_render_includes_related_objects_and_analytic_metadata():
    ...
    assert "Related Data Sources (MITRE objects): Process (DS0001)" in rendered
    assert "Related Data Components (MITRE objects): Process Creation (DC0001)" in rendered
    assert "Related Mitigations (MITRE objects): Mitigation Example (M0001)" in rendered
    assert "Related Software/Tools (MITRE objects): Tool Example [tool] (S0001), Malware Example [malware] (S0002)" in rendered
