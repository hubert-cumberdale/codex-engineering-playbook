...
- Evidence artifacts (if produced) should be written to stable paths under `artifacts/<taskpack-id>/`
  with deterministic filenames (avoid timestamps in filenames).
